...
module.exports.fontsBuild = fontsBuildTask;

// WATCHER
let fontsWatch = function () {
...
const fontsWatchTask = base.gulp.series([fonts, fontsWatch]);
...
module.exports.fontsWatch = fontsWatchTask;
